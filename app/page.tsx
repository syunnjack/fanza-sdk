...
export const metadata: Metadata = {
  title: "比較LAB｜作品選びを、透明に。",
  description: "複数の公式ASP API・フィードを横断する比較・発見メディア。評価軸、出典、広告関係を明示し、審査済みUGCで納得できる作品選びを支援します。",
  alternates: { canonical: "/" },
};

const siteUrl = process.env.SITE_URL ?? "https://hikakulab.jp";
const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    { "@type": "WebSite", name: "比較LAB", url: siteUrl, inLanguage: "ja-JP" },
    { "@type": "Organization", name: "比較LAB編集部", url: siteUrl },
